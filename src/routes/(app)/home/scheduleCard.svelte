							...
							>
								...
								<div
									class={cn(
										...
										{
											'bg-green-500/60': itemProgress == 100
										},
										index === todayIndex && itemProgress > 0 && 'animate-progress-fill',
										index === todayIndex && itemProgress === 100 && 'animate-glow'
									)}
...
<style lang="postcss">
	...
	:global(.animate-progress-fill) {
		animation: progress-fill 400ms ease-out;
	}
