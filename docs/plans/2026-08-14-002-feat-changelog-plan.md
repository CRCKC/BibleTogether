...
- [ ] U1. **Define bundled changelog data and release-version contract**
...
- [ ] U2. **Build the localized changelog page and Settings entry**
...
- [ ] U3. **Add one-time post-update discovery notice**
